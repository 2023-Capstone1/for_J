    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CSDN_AllDayTrueStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 현재 날짜 데이트 피커로 보내기
                DialogFragment CSDN_DateDialog = new DatePickerFragment(selectedDate, CalSetDateNew.this);
                ...
                if(isChecked){
                    ...
                    CSDN_AllDayFalseStartTime.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            // 현재 시간 타임 피커로 보내기
                            DialogFragment HSDN_TimeDialog = new TimePickerFragment(selectedDate, CalSetDateNew.this);
