...
public class HabitDialog {
    ...
    public HabitDialog(Context context, HabitListAdapter listItemAdapter, TextView listCountText, int clickedPosition, String dialogTitle, ListView listView) {
        ...
        // 수정
        View updateBtn = dialog.findViewById(R.id.habitDialog_updateBtn);
