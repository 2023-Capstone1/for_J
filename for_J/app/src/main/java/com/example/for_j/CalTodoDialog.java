...
import com.example.for_j.dialog.CalTodoDeleteCheckDialog;
import com.example.for_j.dialog.TodoDeleteCheckDialog;

import java.text.ParseException;


public class CalTodoDialog {
    private final Dialog dialog;
    private final Context context;
    private final CalTodoListAdapter listItemAdapter;
    ...
    public CalTodoDialog(Context context, CalTodoListAdapter listItemAdapter, int clickedPosition, String dialogTitle, ListView listView) {
...
//        updateBtn.setOnClickListener(v -> modifyCheckBoxImg(radioGroup));
    ...
    private void deleteListItem() {
        ...
        CalTodoDeleteCheckDialog TDCD = new CalTodoDeleteCheckDialog(context, new CalTodoDeleteCheckDialog.TodoDeleteCheckDialogListener() {
            @Override
        ...
        TDCD.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
